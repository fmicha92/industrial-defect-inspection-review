...
- Place citations next to the specific claim they support; avoid sentence-final citation clusters that cover several independent claims
- If one sentence needs many citations, split it into focused clauses or sentences, use representative citations in prose, or move exhaustive support to a table or supplement
...
3. **Integrate citations naturally and locally** within sentences, placing each citation beside the exact claim it supports rather than grouping citations at the end
...
5. Verify all citations are accurate, properly formatted, and placed next to the claims they support rather than dumped at sentence or paragraph ends
